...
mkdir -p src/routes/actions/codex

cat <<EOF > src/routes/actions/codex/dispatch.ts
...
git add src/routes/actions/codex/dispatch.ts
git commit -m "Add codex dispatch route"
