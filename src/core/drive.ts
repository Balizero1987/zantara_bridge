...
/**
 * Recupera info sull’utente (se disponibile). In caso di errore, undefined.
 */
...
/**
 * whoami(): test di accesso SA-Only usando REST (token bearer) per evitare problemi di libreria.
 */
export async function whoami(): Promise<{ ok: true; about?: any; sample?: any; drive?: any; user?: any; service_account?: string | null }> {
  ...
  // About via REST (niente eccezione se fallisce)
  let about: any = null;
  try {
